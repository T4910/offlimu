...
void main() {
  test('clearAllUserData removes wallet ledger rows and bundle records', () async {
    ...
    await bundleRepository.save(
      Bundle(
        ...
        payload: '{"kind":"reward","rewardKind":"relay","amountMinorUnits":5000,"createdAtMs":1700018000000}',
        createdAt: DateTime.fromMillisecondsSinceEpoch(1700018000000),
        ttlSeconds: 3600,
